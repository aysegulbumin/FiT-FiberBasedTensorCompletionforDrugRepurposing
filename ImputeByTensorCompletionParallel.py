...
def parallel_clusters(each_set, rank, alpha_, train_list ,test_list):
    global ImputedTensors
    global GenesPredicted
    global GenesActual
    global General_test_error
    global General_test_norm_square

    tf_sgd_constant = TF_SGD(each_set,rank, alpha_, 120,2, train_list, test_list)
    general_sgd_constant, time_sgd_constant, test_error, test_norm = tf_sgd_constant.train(1,0)
...
f = open("ImputedTensorSeed"+str(cluster_seed)+"Level"+str(cluster_level)+".pkl","wb")
